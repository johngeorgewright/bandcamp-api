...
export const UpdateShippedRequestParser = z.strictObject({
  items: z
    .strictObject({
      id: z
        .number()
      ...
      ship_date: DateParser.optional().describe(
...
export type UpdateShippedRequest = z.input<typeof UpdateShippedRequestParser>
