...
export const SalesReportRequest = z.strictObject({
  band_id: z
    .number()
    .describe(
...
export type SalesReportRequest = z.input<typeof SalesReportRequest>
