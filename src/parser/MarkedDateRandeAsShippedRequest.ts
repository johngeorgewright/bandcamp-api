...
export const MarkedDateRandeAsShippedRequest = z.strictObject({
  band_id: z
    .number()
  ...
  start_time: Date.optional().describe(
    '(optional) earliest date in range of orders',
  ),
  end_time: Date.describe(
...
export type MarkedDateRandeAsShippedRequest = z.input<
  typeof MarkedDateRandeAsShippedRequest
>
